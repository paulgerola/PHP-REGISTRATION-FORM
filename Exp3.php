...
if (empty($_GET['Submit']))
{
    ...
    print ("Sorry you can't view this page!!! <a href=index.html> Login First before to proceed!!!</a>");
}
?>
    <div style="background-color: #bfe752;">
    ...
    <fieldset>
        <legend<h2>School Information:</h2></legend>
            <table>
